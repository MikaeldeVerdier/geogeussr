from dataset_generator_components.dataset_generator import DatasetGenerator

API_KEY = "API_KEY"  # str
SECRET = None  # str | None

SHAPEFILE_PATH = "data/dissolved_gadm.gpkg"  # str
DATASET_DIR = "data/datasets/dataset"  # str
