...
class StreetPreprocessorOriginal(Preprocessor):
    ...
    def __call__(self, chosen_annotations, use_augmentation=False, rets=[], passed_processed_images=None, passed_images=None, passed_prompts=None, **kwargs):  # could unify with other clip preprocessors
