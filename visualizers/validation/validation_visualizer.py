...
class ValidationVisualizer:
    ...
    def plt_histo(self, bins, correct_dists, incorrect_dists, plot_density):
    ...
    def visualize_distribution(self, grouping_size=viz_cfg.grouping_size, plot_density=viz_cfg.plot_density, plot_stacked=viz_cfg.plot_stacked):
        dists = np.array(self.validation_information["distances"])
        was_corrects = np.array(self.validation_information["correct_regions"])
        was_corrects = np.random.choice([True, False], len(dists))  # for testing
        ...
        if plot_stacked:
            ...
            self.plt_histo(bins, correct_dists, incorrect_dists, plot_density)   
